...
sed -i 's/avic_unaccelerated_access_interception,/avic_unaccelerated_access_interception,\n\t[SVM_EXIT_RDTSC]           = handle_rdtsc_interception,/g' submodules/ubuntu-kernel/arch/x86/kvm/svm/svm.c
